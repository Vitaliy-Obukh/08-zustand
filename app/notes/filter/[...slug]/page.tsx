import { fetchNotes } from "@/lib/apiйй";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      url:
        slug[0] === "all"
          ? `https://08-zustand-eypfyygwr-yelyzaveta-musianovychs-projects.vercel.app/notes/filter/all`
          : `https://08-zustand-eypfyygwr-yelyzaveta-musianovychs-projects.vercel.app/notes/filter/${tag}`,
      images: [
        {
